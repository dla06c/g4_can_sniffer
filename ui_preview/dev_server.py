    ...
    def do_GET(self):
        ...
        if parsed.path == "/canStatus":
            return self.send_json({
                ...
                "decoded_frames": int((time.time() - start) * 150),
                "channel_1_id": 1000,
                "channel_2_id": 1001,
                "channel_3_id": 1002,
                "channel_1_frames": int((time.time() - start) * 50),
                "channel_2_frames": int((time.time() - start) * 50),
                "channel_3_frames": int((time.time() - start) * 50),
                "channel_1_age_ms": 10,
                "channel_2_age_ms": 12,
                "channel_3_age_ms": 15,
