...
<body>
  ...
  <nav>
    <button id="btn_cardash" class="dashboard-tab active" onclick="showPage('cardash')" aria-label="Drive">
      ...
      <span class="sr-only">Drive</span>
    </button>
    <button id="btn_gear" class="dashboard-tab" onclick="showPage('gear')" aria-label="Gear">
    ...
    <button id="btn_light" class="dashboard-tab" onclick="showPage('light')" aria-label="Light">
...
function showPage(name) {
  const pages = ['cardash', 'gear', 'light'];
